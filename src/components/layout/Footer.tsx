      ...
      <Container maxWidth="lg" className="py-6"> {/* Increased vertical padding for better spacing */}
        ...
        <Box className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-16"> {/* Increased gap for desktop */}
          ...
          <Box className="flex-1 min-w-0 lg:max-w-xs"> {/* Capping max width for brand text on large screens for readability */}
            ...
            {/* Social Links */}
            <Box className="flex gap-4"> {/* Increased gap between icons */}
              <IconButton 
                size="large" 
          ...
          {/* 2. Quick Links & Apps - (The central columns) */}
          {/* Mobile: w-full justify-between pushes links to edges. PC: Fixed gap and auto width. */}
          <Box className="flex justify-between w-full lg:w-auto lg:flex-row lg:gap-20"> 
            
            {/* Quick Links */}
            <Stack spacing={0.3} className="min-w-24"> {/* Slightly increased spacing */}
             <Typography variant="h6" className="!font-light text-white text-sm border-b border-blue-400/50 pb-1">
                Quick Links
              </Typography>
            ...
            {/* Apps Section */}
            <Stack spacing={0.3} className="min-w-28"> {/* Slightly increased spacing */}
              <Typography variant="h6" className="!font-light text-white text-sm border-b border-blue-400/50 pb-1">
                Our Apps
              </Typography>
              <Link
          ...
          {/* 3. Developer Credit - Styled and positioned to the right edge */}
          <Box className="lg:mt-0 mt-8 flex lg:justify-end justify-start w-full lg:flex-1 lg:max-w-48">
            <Box className="bg-gray-800 rounded-xl p-1 w-full max-w-56 shadow-2xl border border-blue-500/30"> {/* Updated styling for prominence */}
              ...
              <Link
                ...
                // Made the button more prominent with full padding
